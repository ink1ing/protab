...
ProTab 是极强大的 macOS 全局快捷键系统，通过Tab组合执行各种操作。

## 🚀 功能特性

- **快捷键触发**: Tab + 字母组合触发各种复杂指令.
- **功能强大**: 已集成功能15+，包含内存释放，claude code配置，r2存储桶文件上传等等
- **自由配置**: JSON 配置文件，支持自定义快捷键和脚本.
- **极其轻量**: 项目<300KB，内存占用<1MB，支持开机自启动/静默启动.
- **测试完备**: 95%+ 测试覆盖，确保稳定性.
